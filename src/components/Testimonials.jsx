...
const Circles = ({ iterable, active, onClick }) => (
    <CirclesOuter>{iterable.map((i, idx) => <Circle onClick={() => onClick(i)} active={i == active} key={idx} />)}</CirclesOuter>
)
...
class Testimonials extends React.Component {
    ...
    selectSlide = (key) => {
        clearInterval(this._interval)
        this.setState({ active: key }, () => setInterval(this.switch, __INTERVAL_MS__))
    }
