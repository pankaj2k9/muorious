                ...
                <>
                  <AssistFeature1>
                    <AssistFeature1Content>
                      ...
                      <AssistFeature1Description>
                        {content.feature1Description.feature1Description}
                      </AssistFeature1Description>
                    </AssistFeature1Content>
                    <AssistFeature1Img>
                      <img src={AutomaticCategorizationImg} />
                    </AssistFeature1Img>
                  </AssistFeature1>
                  <AssistFeature2>
                    <AssistFeature2Title>
                    ...
                    <AssistFeature2Description>
                      {content.feature2Description.feature2Description}
                    </AssistFeature2Description>
                    <AssistFeature2Details>
                      <AssistFeature2Img>
                        <img src={TemplateRecommandationImg} />
                      </AssistFeature2Img>
                      <div>
                        <AssistFeature2DetailsCard>
                          <AssistFeature2DetailsTitle>
                            {content.feature2SubTitle1}
                          </AssistFeature2DetailsTitle>
                          <AssistFeature2DetailsDescription>
                            {
                              content.feature2SubDescription1
                        ...
                        <AssistFeature2DetailsCard>
                          <AssistFeature2DetailsTitle>
                            {content.feature2SubTitle2}
                          </AssistFeature2DetailsTitle>
                          <AssistFeature2DetailsDescription>
                            {
                              content.feature2SubDescription2
                        ...
                        <AssistFeature2DetailsCard>
                          <AssistFeature2DetailsTitle>
                            {content.feature2SubTitle3}
                          </AssistFeature2DetailsTitle>
                          <AssistFeature2DetailsDescription>
                            {
                              content.feature2SubDescription3
              ...
              <Breakpoint medium down>
                <>
                  <AssistFeature1>
                    ...
                    <p>
                      Your customer service data can be a gold mine when agents
                      properly tag and categorize their tickets. When they are
                      not, it can be pretty difficult to extract meaningful
                      insights. Miuros uses AI to automatically identify the
                      ticket category and apply the proper one to it.
                    </p>
                    <img src={AutomaticCategorizationImg} />
                  </AssistFeature1>
                  <AssistFeature2>
                    ...
                    <p>
                      You have spent hours building a library of templates
                      tailored to specific requests and problems you have
                      identified. You know they perform well. Miuros helps your
                      agents take better advantage of it.
                    </p>
                    <AssistFeature2Details>
                      <AssistFeature2Img>
                        <img src={TemplateRecommandationImg} />
